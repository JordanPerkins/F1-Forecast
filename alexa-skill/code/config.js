...
module.exports = () => ({
    ...
    levenshteinConstructorThreshold: process.env.OVERRIDE_LEVENSHTEIN_CONSTRUCTOR_THRESHOLD ? Number.parseInt(process.env.OVERRIDE_LEVENSHTEIN_CONSTRUCTOR_THRESHOLD, 10) : 2,
